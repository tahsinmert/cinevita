...
import { searchMovies, getMovieById, type OmdbMovie, type OmdbMovieFull } from '@/lib/omdb'
...
export default function MovieList({ initialMovies }: { initialMovies: OmdbMovie[] }) {
  ...
  const query = useInfiniteQuery({
    ...
    initialData: { pages: [{ Search: initialMovies, totalResults: 10 }], pageParams: [1] },
    initialPageParam: 1,
